...
import blobs from "../../assets/blobs-1.svg"
import mouse from "../../assets/mouse.svg"
import transition2 from "../../assets/transition-2-slate-50.svg"
    ...
    return (
        <section class="flex flex-col gap-7 items-center bg-white min-h-screen bg-[url('/circles-slate-50.svg')] relative">
            ...
            <div class="my-32 flex justify-around text-slate-800 items-center w-auto xl:w-[1280px]">
                <img src={blobs} class="max-xl:hidden rotate-180"></img>
            ...
            <img class="absolute bottom-64 right-48 max-xl:hidden" src={mouse}></img>
            <img src={transition2} class="w-full"></img>
        </section>
    );
}
